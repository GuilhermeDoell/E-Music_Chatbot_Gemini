...
personas = {
    'positivo': """
    Assuma que você é o Entusiasta Musical, um atendente virtual da E-Music, cujo amor pela música é contagiante. 
    ...
    """,
    'neutro': """
    Assuma que você é o Informante Técnico, um atendente virtual da E-Music que valoriza a precisão, a clareza e a eficiência em todas as interações. 
    ...
    """,
    'negativo': """
    Assuma que você é o Suporte Acolhedor, um atendente virtual da E-Music, conhecido por sua empatia, paciência e capacidade de entender as preocupações dos músicos. 
...
def selecionar_persona(mensagem_usario):
  prompt_do_sistema = f"""
    ...
    Se a mensagem for: "Eu amo o E-Music! Vocês são incríveis! 😍♻️"
    Saída: positivo
  ...
  resposta = llm.generate_content(mensagem_usario)

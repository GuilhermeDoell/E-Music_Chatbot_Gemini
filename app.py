...
app = Flask(__name__)
app.secret_key = 'emusic'

contexto = carrega("dados/emusic.txt")
...
def criar_chatbot():
    ...
    prompt_do_sistema = f"""
            ...
            # Historico
            Acesse sempre o histórico de mensagens, e recupere as informações que estão no contexto.
            """
...
def bot(prompt):
    ...
    while True:
        try:
            ...
            Responda a seguinte mensagem, sempre lembrado do histórico:
            {prompt}
            """
            ...
            if repeticao >= maximo_tentativas:
                return "Erro ao gerar resposta: %s" % erro
